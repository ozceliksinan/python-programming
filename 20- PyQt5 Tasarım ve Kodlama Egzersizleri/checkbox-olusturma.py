...
class Pencere(QWidget):
    ...
    def init_ui(self):
        ...
        self.setWindowTitle("Check Box Mini Proje")

        # Checkbox işaretlendi mi, işaretlenmedi mi bilgisi için;
        # isChecked(): Bizim için yazılmış hazır bir fonksiyondur. İşaretlendi mi kontrolu yapar.
        # Lambda yazılmaz ise sorgumuz fonksiyon olarak döner. Lambda yazıldığı zaman fonksiyon objesi olarak döner.
        # Dönen fonksiyon objesini click fonksiyonuna göndeririz.
